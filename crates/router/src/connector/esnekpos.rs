    ...
    for Esnekpos
{
    ...
    fn get_url(
        ...
        logger::info!("getting the payment url right now");
    ...
    fn build_request(
        ...
        logger::info!("building the request right now");
        ...
        logger::info!("esnek execute payment request: {:?}", req);
    ...
    fn handle_response(
        ...
        logger::info!("handling the response right now");

        logger::info!("the received response is: {:?}", res);
        ...
        logger::info!(
            "well the response ORDER_REF_NUMBER is: {:?}",
            response.order_ref_number
        );
    ...
    fn get_error_response(
        ...
        logger::info!(
            "building the error response right now. they gave us: {:?}",
            res
        );
